var adjectives = ["Slippery", "Moist", "Soggy", "Salty", "Deadly", "Plump", "Obese", "Spiky", "Fizzy", "Fuzzy", "Hairy", "Bald", "Thicc", "Fluorescent", "Feeble", "Evil", "Juicy", "Monstrous", "Dead", "Loud", "Silent", "Swift", "Sly", "Cylindrical", "Tubular", "Giant", "Invisible", "Infected", "Annoyed", "Gassy", "Intoxicated", "Toxic", "Blind", "Bloated", "Explosive", "Stinky", "Crispy", "Roasted", "Baked", "Flying", "Lumpy", "Fluffy", "Sleepy", "Special", "Drowsy", "Iridescent", "Musical", "Deformed", "Cheeky", "Impregnated", "Fossilised", "Bleached", "Moldy", "Decaying", "Burnt", "Evaporated", "Folded", "Murderous", "Spicy", "Windy", "Flooded", "Moly", "Eager", "Fried", "Tight", "Seared", "Drowned", "Spacious", "Steamy", "Sexy", "Flappy", "Cute", "Whimsical", "", "Warped", "Dull", "Smug", "Brave", "Crazy", "Hungry", "Foul", "Bent", "Crooked", "Curly", "Sinister", "Broken", "Barking", "Yellow", "Blue", "Green", "Orange", "Red", "Purple", "Scorched", "Exuberant", "Excited", "Happy", "Jovial", "Satanic"];
