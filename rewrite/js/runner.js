(function(){
    ...
    gameMap[3].setOwner(tstpl2.getTeamId(), tstpl2.getTeamColour(), tstpl2.getId(), tstpl2.getColour(), tstpl2.getInverse(), tstpl2.getChars()[1], tstpl2.getChars()[0]);

    move(tstpl2.makeMove(gameMap), tstpl2, gameMap);
