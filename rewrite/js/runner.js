(function(){
    ...
    //startMenu(colList);
    inGame();
    var gameMap = mapConverter(galconGalaxy8());

    //oldMapParser(gameMap);

    var activePlayer = 1;
    var settings = {playing: true, botTurn: false, hideScores: false, spawnCount: 100, randShields: false, randBlocks: false, fog: false, debug: false};
